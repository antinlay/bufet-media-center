...
ActiveRecord::Schema[8.1].define(version: 2026_02_05_090000) do
  ...
  create_table "player_devices", force: :cascade do |t|
    t.datetime "created_at", null: false
    ...
    t.integer "screen_id"
    t.datetime "updated_at", null: false
    t.index ["device_id"], name: "index_player_devices_on_device_id", unique: true
    t.index ["screen_id"], name: "index_player_devices_on_screen_id"
  end

  create_table "player_pairings", force: :cascade do |t|
    t.string "code", null: false
    t.datetime "created_at", null: false
    t.datetime "expires_at", null: false
    t.datetime "paired_at"
    t.integer "player_device_id", null: false
    t.integer "screen_id"
    t.datetime "updated_at", null: false
    t.index ["code"], name: "index_player_pairings_on_code", unique: true
    t.index ["player_device_id"], name: "index_player_pairings_on_player_device_id"
    t.index ["screen_id"], name: "index_player_pairings_on_screen_id"
  end
  ...
  add_foreign_key "groups", "groups", column: "parent_id", on_delete: :nullify
  add_foreign_key "memberships", "groups"
  add_foreign_key "memberships", "users"
  add_foreign_key "player_devices", "screens"
  add_foreign_key "player_pairings", "player_devices"
  add_foreign_key "player_pairings", "screens"
